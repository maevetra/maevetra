        ...
        <main
            className="min-h-screen flex flex-grow flex-row items-center justify-between justify-items-center text-center bg-[#EAEAEA] px-12">
                ...
                <ul className="m-auto mt-3 flex flex-row justify-items-center justify-evenly list-none">
                    <Link href='#about' scroll={true} className="cursor-pointer">  <svg fill="#580C0C" className='inline-flex mr-4 pb-1' xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
                                ...
                                About</Link>
                    <Link href='#projects' className="cursor-pointer">  <svg fill="#580C0C" className='inline-flex mr-4 pb-1' xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
                                <path d="M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80V432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z"/></svg>
                                Projects</Link>
                    <Link href='#contact' className="cursor-pointer">  <svg fill="#580C0C" className='inline-flex mr-4 pb-1' xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
                                <path d="M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80V432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z"/></svg>
                                Connect</Link>
                </ul>
                    </motion.header>
