...
const Heading = (props) => {
    return (
        <div className="mb-10">
            ...
            <h2 className="mt-1 text-4xl font-black uppercase tracking-wide sm:text-4xl">{props.title}</h2>
            ...
            <div className='flex flex-cols justify-between'>
                ...
                <svg className='inline-flex mr-4' fill="#28364C"
                ...
                <div className='inline-flex' id='play-btns'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 640 512" fill="#28364C">
                        <path
